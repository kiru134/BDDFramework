...
Feature: Outsation path 
  ...
  Scenario Outline: Outstaion cab services
    ...
    And  price of car in booking details


    Examples: 
      | FromCity               | ToCity                  | pickupdate  |monthyear     | time      |
      | "Bangalore, Karnataka" |  "Chennai, Tamil Nadu"  |"22"         |"January2022" |"11:45 PM" |
    ...
    And  price of car booking details


    Examples: 
      | FromCity               | ToCity                 | pickupdate  | monthyear      | return date| time      |
      | "Bangalore, Karnataka" | "Chennai, Tamil Nadu"  |"22"         | "January2022"  |"24"        | "11:45 PM"|
