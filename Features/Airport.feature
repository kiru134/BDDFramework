...
Feature: Airport 
  ...
  Scenario Outline: Airport cab services
    ...
    Examples: 
      ...
      | "Bangalore Airport, Bangalore" |  "Cab from the Airport"  |   "Rajajinagar,Bangalore"| "22"       | "January2022"|"11:45 PM"  |
      | "Bangalore Airport, Bangalore" |  "Cab to the Airport"    |   "Rajajinagar,Bangalore"| "22"       | "January2022"|"11:45 PM"  |
